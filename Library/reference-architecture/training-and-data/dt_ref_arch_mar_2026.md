...
The architecture is organized into two main sub-systems (Training and Data Platform), one Observability and one Lineage system for a total of four sub-systems:
...
- **Data Platform**: The part of the platform responsible to perform all the data related operations, it's managed by Data Engineers. This system is organized into different layers:
  - **Data Platform Orchestrator Layer**: The layer the Data Engineers interact with for running diverse workflows, including *data ingestion*, *data vetting* and *data transformations*.
...
- **Training Platform**: The part of the platform responsible to perform all the data science related operations, it's managed by Data Scientists and contains the following layers:
  - **Training Platform Orchestrator Layer**: The layer the Data Scientist interact with for running diverse workflows, including *model ingestion*, *model vetting* and *model training*.
...
- **Observability Layer**: This sub-system is in charge of collecting all the logs, traces and metrics generated during data and training operations. 
- **Attestation and Lineage Layer**: This layer stores all the processes attestation that ensures the lineage of the model artifacts and datasets to their original sources.
